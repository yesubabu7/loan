...
public class CustomerController {
	...
	public void acceptOrReject(@RequestParam("applicantId") Long applicantId,
	...
	public String emiScheduleCheck(
	    @RequestParam("customerId") int customerId,LoanApplicationForm loanApplication,Customer cust, Model model)
	{
    ...
    public String saveEmiSchedule(
    		 @RequestParam("loanId") String loneAppId,
    		 @RequestParam("MonthlyEmi") String emiPerMonth,
            ...
            @RequestParam("repayableAmount") String repayableAmount,
		...
		boolean b=customerservice.emiScheduleDataService(loneAppId,emiPerMonth,customerId,
				emiStartDate,annualInterestRate,monthlyInterestRate,numberOfPayments,repayableAmount,loanAmount);
