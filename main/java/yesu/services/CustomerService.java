...
import yesu.entities.AuthUtils;
...
public class CustomerService {
	...
	public List<Customer> getAllCustomerUsersService(String username, String password, HttpSession session) {
	...
	public List<String> getUrlPatterns(int userId) {
		
		List<String> patternList= customerdao.getPatternsFromDao(userId);
