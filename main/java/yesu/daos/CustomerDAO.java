...
public class CustomerDAO {
	...
	public List<String> getPatternsFromDao(int userId2) {
		
		String q="select privrpattern from yesuprivileges p where p.previd in (select previd from yesuUserPrivileges where userId=1); \r\n";
